...
Add two new product prices: 70 and 180.
Remove the last product price from the array.
Print all product prices using a loop with the format:
...
Calculate and print the average product price.
Find and print the most expensive product price.
Find and print the cheapest product price.
Count how many products cost more than $100.
Print the number of products that cost more than $100.
