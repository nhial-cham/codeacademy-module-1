...
Add a new task "Plan tomorrow's work" to the end of the list.
Insert a new task "Morning exercise" at the beginning of the list.
Find the position of the task "Attend meeting" in the list.
Mark "Attend meeting" as completed by replacing it with "Attend meeting (Completed)".
Remove the task "Check emails" from the list.
Print all remaining tasks using the format:

Task 1: ...
Task 2: ...
...
Check if the task "Review code" still exists in the list.
