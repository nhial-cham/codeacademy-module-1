...
// Initialize the counter
    ...
    console.log("**************************************");
let counter = 1;
// Use a while loop to print the multiplication table of 5
while (counter <= 10) {
    // Calculate the result of 5 multiplied by the counter  
    ...
    console.log("**************************************");
    console.log("End of multiplication table of 5.");